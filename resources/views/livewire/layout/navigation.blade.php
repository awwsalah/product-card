...
@endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('users.show', auth()->user()->id)" :active="request()->routeIs('dashboard')" wire:navigate>
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('users.show', auth()->user()->id)" wire:navigate>
                    {{ __('Profile') }}
                </x-responsive-nav-link>
